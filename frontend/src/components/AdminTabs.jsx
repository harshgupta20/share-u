...
export default () => {
  ...
  return (
    ...
    >
      ...
      >
        {tabItems.tabNames.map((item, idx) => (
          <Tabs.Trigger
            key={idx}
      ...
      <Tabs.Content className="py-6" value={selectedTab}>
        {selectedTab == "Overview" ? "Inside Overview" : selectedTab == "Integration" ? "Inside Integration" : selectedTab == "Billing" ? "Inside Billing" : selectedTab == "Transactions" ? "Inside Transactions" : selectedTab == "Users" ? <UserTable/> : "Not Tab Data Found!"}
      </Tabs.Content>
